...
const ExclusiveOffers = () => {
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 x1:px-32 pt-20 pb-30'>
        <div className='flex flex-col md:flex-row items-center justify-between-full'>
            <Title align='left' title='Exclusive Offers' subTitle='Take advantage of  our limited-tome offers and special packages to enhance your stay and create unforgettable memories.'/>
