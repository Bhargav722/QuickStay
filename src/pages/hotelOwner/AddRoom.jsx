    ...
    <form>
        ...
        <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
            ...
            <div>
                ...
                <input type='number' placeholder='0' className='border border-gray-300 mt-1 ronded p-2 w-24' value={inputs.pricePerNight} onChange={e=>setInputs({...inputs, pricePerNight: e.target.value})}/>
            </div>
        </div>
       ...
       <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-2 rounded mt-8 cursor-pointer">Add Room</button>
    </form>
  )
}
