        ...
        <div>
            ...
            {roomsDummyData.map((room)=>(
                <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                    <img onClick={()=> {navigate(`/rooms/${roomsDummyData._id}`);scrollTo(0,0)}}
                    ...
                    <div className='md:w-1/2 flex flex-col gap-2'>
                        ...
                        <p onClick={()=> {navigate(`/rooms/${roomsDummyData._id}`);scrollTo(0,0)}} className='text-gray-800 text-3x1 font-playfair cursor-pointer'>{room.hotel.name}</p>
